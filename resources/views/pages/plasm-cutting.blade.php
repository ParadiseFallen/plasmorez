            ...
            <div class="row">
                <div class="col-5 d-flex flex-column">
                    <div class="fancy-card d-flex my-2">
                        <div class="row w-100">
                            <div class="number col-2 d-flex justify-content-center align-items-center">
                                <span class="px-2 d-block">1</span>
                            </div>
                            <div class="text d-flex flex-column col-10 justify-content-center align-content-center">
                ...
                <div class="col-5">
                    <div class="fancy-card d-flex my-2">
                        <div class="row w-100">
                            <div class="order-last number col-2 d-flex justify-content-center align-items-center">
